import numpy as np
from numpy import * # 导入 numpy 库函数
...
class KNearestNeighbor(object):
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in range(num_test):
      ...
      #########################################################################
      #pass
      distances = dists[i, :]   # 每个测试样本所计算的欧氏距离
      indexs = np.argsort(distances)    # np.argsort 对 distances 进行从小到大排序
      closest_y = self.y_train[indexs[: k]] # 找到距离最近的 k 个训练样本对应的标签
